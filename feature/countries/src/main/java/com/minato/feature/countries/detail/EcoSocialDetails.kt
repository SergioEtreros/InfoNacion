...
import com.minato.feature.countries.toNaturalText
...
fun EcoSocialDetails(country: Country) {
   Column(
      ...
      InfoDataItem(
         title = stringResource(R.string.car_side),
         info = country.carSide.toNaturalText(context)
      )
      InfoDataItem(
         title = stringResource(R.string.independient),
         info = country.independent.toNaturalText(context)
      )
   }
}
